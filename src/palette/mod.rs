...
pub(crate) use color_math::oklch_hue;
use color_math::{delta_e_2000, linearize, srgb_to_lab};
...
mod tests {
    ...
    /// OKLCH chroma from sRGB — used only in accent chroma test.
    fn oklch_chroma(r: u8, g: u8, b: u8) -> f64 {
