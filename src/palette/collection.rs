...
fn oatgrass() -> Palette {
    Palette {
        ...
        background: Color::Rgb(242, 235, 215),
        ...
        sort_key: oklch_hue(242, 235, 215),
        color_256: None,
    }
}
...
fn oregon_sunshine() -> Palette {
    Palette {
        ...
        category: AffectiveCategory::LightWarm,
        sort_key: oklch_hue(245, 238, 218),
        color_256: None,
    }
}
...
fn white_oak() -> Palette {
    Palette {
        ...
        category: AffectiveCategory::LightWarm,
        sort_key: oklch_hue(238, 232, 220),
        color_256: None,
    }
}
...
fn ponderosa() -> Palette {
    Palette {
        ...
        category: AffectiveCategory::LightWarm,
        sort_key: oklch_hue(240, 232, 210),
        color_256: None,
    }
}
...
fn balsamroot() -> Palette {
    Palette {
        ...
        category: AffectiveCategory::LightWarm,
        sort_key: oklch_hue(242, 232, 208),
        color_256: None,
    }
}
...
fn pearly_everlasting() -> Palette {
    Palette {
        ...
        category: AffectiveCategory::LightCool,
        sort_key: oklch_hue(235, 236, 238),
        color_256: None,
    }
}
...
fn lupine() -> Palette {
    Palette {
        ...
        category: AffectiveCategory::LightCool,
        sort_key: oklch_hue(225, 232, 242),
        color_256: None,
    }
}
...
fn paintbrush() -> Palette {
    Palette {
        ...
        sort_key: oklch_hue(242, 235, 228),
        color_256: None,
    }
}
...
fn tiger_lily() -> Palette {
    Palette {
        ...
        category: AffectiveCategory::LightVivid,
        sort_key: oklch_hue(242, 238, 225),
        color_256: None,
    }
}
...
fn goatsbeard() -> Palette {
    Palette {
        ...
        category: AffectiveCategory::LightMuted,
        sort_key: oklch_hue(236, 238, 235),
        color_256: None,
    }
}
...
fn reindeer_lichen() -> Palette {
    Palette {
        ...
        category: AffectiveCategory::LightMuted,
        sort_key: oklch_hue(232, 236, 230),
        color_256: None,
    }
}
