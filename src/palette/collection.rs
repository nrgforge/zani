...
pub(super) fn default_palette() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(145, 165, 138),
...
fn chinquapin() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(198, 178, 108),
...
fn sitka() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(148, 178, 172),
...
fn oakmoss() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(118, 175, 162),
...
fn witchs_hair() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(152, 170, 118),
...
fn fly_agaric() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(215, 88, 78),
...
fn lobaria() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(108, 205, 118),
...
fn violet_cort() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(158, 108, 205),
...
fn salal() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(128, 118, 198),
...
fn usnea() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(155, 172, 158),
...
fn bracken() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(118, 98, 15),
        accent_link: Color::Rgb(35, 88, 82),
        accent_code: Color::Rgb(92, 82, 62),
        category: AffectiveCategory::LightWarm,
        sort_key: oklch_hue(240, 242, 222),
        color_256: None,
    }
}
...
fn white_oak() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(115, 92, 62),
...
fn ponderosa() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(135, 95, 35),
        accent_link: Color::Rgb(40, 92, 78),
        accent_code: Color::Rgb(92, 80, 58),
        category: AffectiveCategory::LightWarm,
        sort_key: oklch_hue(246, 228, 212),
        color_256: None,
    }
}
...
fn pearly_everlasting() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(88, 92, 98),
        accent_link: Color::Rgb(60, 90, 72),
        accent_code: Color::Rgb(72, 78, 88),
        category: AffectiveCategory::LightCool,
        sort_key: oklch_hue(224, 236, 246),
        color_256: None,
    }
}
...
fn partridgefoot() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(82, 88, 78),
        accent_link: Color::Rgb(82, 72, 105),
        accent_code: Color::Rgb(72, 85, 80),
        category: AffectiveCategory::LightCool,
        sort_key: oklch_hue(222, 240, 234),
        color_256: None,
    }
}
...
fn lupine() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(58, 72, 138),
        accent_link: Color::Rgb(82, 88, 58),
        accent_code: Color::Rgb(70, 78, 100),
        category: AffectiveCategory::LightCool,
        sort_key: oklch_hue(220, 228, 248),
        color_256: None,
    }
}
...
fn oregon_sunshine() -> Palette {
    Palette {
        ...
        background: Color::Rgb(252, 245, 195),
        ...
        category: AffectiveCategory::LightVivid,
        sort_key: oklch_hue(252, 245, 195),
        color_256: None,
    }
}
...
fn tiger_lily() -> Palette {
    Palette {
        ...
        background: Color::Rgb(254, 220, 192),
        dimmed_foreground: Color::Rgb(165, 160, 145),
        accent_heading: Color::Rgb(155, 68, 5),
        accent_emphasis: Color::Rgb(108, 52, 38),
        accent_link: Color::Rgb(15, 90, 118),
        accent_code: Color::Rgb(90, 82, 58),
        category: AffectiveCategory::LightVivid,
        sort_key: oklch_hue(254, 220, 192),
        color_256: None,
    }
}
...
fn farewell() -> Palette {
    Palette {
        ...
        foreground: Color::Rgb(48, 38, 42),
        background: Color::Rgb(248, 224, 234),
        dimmed_foreground: Color::Rgb(162, 152, 158),
        accent_heading: Color::Rgb(168, 35, 85),
        accent_emphasis: Color::Rgb(162, 42, 88),
        accent_link: Color::Rgb(10, 100, 102),
        accent_code: Color::Rgb(88, 75, 78),
        category: AffectiveCategory::LightVivid,
        sort_key: oklch_hue(248, 224, 234),
        color_256: None,
    }
}
...
fn oceanspray() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(118, 98, 68),
...
fn goatsbeard() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(82, 82, 78),
        accent_link: Color::Rgb(85, 75, 65),
        accent_code: Color::Rgb(75, 80, 78),
        category: AffectiveCategory::LightMuted,
        sort_key: oklch_hue(235, 240, 234),
        color_256: None,
    }
}
...
fn fringecup() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(148, 78, 92),
        accent_link: Color::Rgb(52, 85, 82),
        accent_code: Color::Rgb(85, 75, 78),
        category: AffectiveCategory::LightMuted,
        sort_key: oklch_hue(238, 232, 234),
        color_256: None,
    }
}
...
fn silver_fir() -> Palette {
    Palette {
        ...
        accent_emphasis: Color::Rgb(78, 98, 78),
        accent_link: Color::Rgb(80, 72, 90),
        accent_code: Color::Rgb(75, 82, 72),
        category: AffectiveCategory::LightMuted,
        sort_key: oklch_hue(230, 235, 242),
        color_256: None,
    }
}
