...
impl Palette {
    ...
    /// Green exposure is linked to enhanced creative ideation (Lichtenfeld et al., 2012).
    pub fn aurora() -> Self {
        Self {
            name: "Aurora",
...
mod tests {
    ...
    fn index_in_all_finds_known_palette() {
        ...
        assert_eq!(inkwell.index_in_all(), 2);
    }
